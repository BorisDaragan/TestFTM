...
namespace FTM.API.Controllers
{
    public class TeamsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetTeam(Guid id)
        {
        ...
        public async Task<IHttpActionResult> PutTeam(Guid id, Team team)
        {
        ...
        // DELETE: api/Teams/5
        [ResponseType(typeof(Team))]
        public async Task<IHttpActionResult> DeleteTeam(Guid id)
        {
            Team team = await db.Teams.FindAsync(id);
            if (team == null)
            {
